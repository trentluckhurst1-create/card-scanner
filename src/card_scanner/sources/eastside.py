...
BASE_URL: Final[str] = "https://eastsidecollectables.com.au"
COLLECTION_BY_SPORT: Final[dict[str, str]] = {
    "NBA": "raw",
}

# Eastside's raw collection is explicitly NBA singles, but retain a defensive
# sealed-product guard so collection drift cannot contaminate the active-card feed.
...
class EastsideSource:
    name = "eastside"
    source_name = "eastside"
