...
OPPORTUNITY_SCAN_LISTINGS_PER_SPORT = int(
    os.getenv("OPPORTUNITY_SCAN_LISTINGS_PER_SPORT", "50")
)
OPPORTUNITY_SCAN_MAX_CANDIDATES_PER_SPORT = int(
    os.getenv("OPPORTUNITY_SCAN_MAX_CANDIDATES_PER_SPORT", "10")
)
OPPORTUNITY_SCAN_SOLD_RESULTS_PER_QUERY = int(
    os.getenv("OPPORTUNITY_SCAN_SOLD_RESULTS_PER_QUERY", "100")
)
OPPORTUNITY_SCAN_MAX_SOLD_QUERIES = int(
    os.getenv("OPPORTUNITY_SCAN_MAX_SOLD_QUERIES", "80")
)
